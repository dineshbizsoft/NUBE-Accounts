...
{
   public class SubsidaryAccounts : INotifyPropertyChanged
    {
        #region Fields
        ...
        public static List<SubsidaryAccounts> ToList(DateTime dtFrom, DateTime dtTo)
        {
            return NubeAccountClient.NubeAccountHub.Invoke<List<SubsidaryAccounts>>("SubsidaryAccounts_List", dtFrom, dtTo).Result;
        }
